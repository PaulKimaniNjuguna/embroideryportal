                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layers"></i><span>Categories

                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="index.html">Add product category</a></li>
                                    <li><a href="/viewcategory">View product category</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-gift"></i><span>Products</span></a>
                                <ul class="collapse">
                                    <li><a href="barchart.html">Add product</a></li>
                                    <li><a href="linechart.html">View products</a></li>
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i><span>Admin
                                        profile</span></a>
                                <ul class="collapse">
                                    <li><a href="accordion.html">Change admin details</a></li>
                                    <li><a href="alert.html">Logout</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>View product category</span></li>
                            </ul>
                        </div>
                    </div>
